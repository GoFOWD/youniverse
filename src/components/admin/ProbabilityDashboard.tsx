...
export default function ProbabilityDashboard({ choiceScores }: ProbabilityDashboardProps) {
    ...
    const renderPieChart = (
        ...
        return (
            <div className="space-y-4">
                <h3 className="text-lg font-bold text-green-400 uppercase tracking-wider">{title}</h3>
    ...
    return (
        <div className="bg-black border border-green-800 p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {renderPieChart(probabilities.oceanDistribution, oceanColors, 'Ocean Distribution')}
                {renderPieChart(probabilities.seasonDistribution, seasonColors, 'Season Distribution')}
            </div>
        </div>
    );
}
