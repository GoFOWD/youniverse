  ...
  return (
    <div className="flex flex-col items-center w-full h-full relative z-20">
      ...
      <motion.div
        ...
        className="pt-[140px] sm:pt-20 md:pt-24 relative z-20 text-center flex flex-col items-center space-y-10 sm:space-y-8"
      >
        <div className="relative inline-block">
          ...
          />
          <h1 className=" relative text-5xl sm:text-5xl md:text-6xl font-bold tracking-wider text-white" style={{ fontFamily: "'Playfair Display', serif", textShadow: '0 2px 8px rgba(0, 0, 0, 0.3), 0 4px 16px rgba(0, 0, 0, 0.2)' }}>
            나의 바다를
            <br />
            찾아서
          </h1>
